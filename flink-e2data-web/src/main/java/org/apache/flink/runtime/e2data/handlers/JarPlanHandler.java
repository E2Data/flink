...
package org.apache.flink.runtime.e2data.handlers;

import org.apache.flink.api.common.time.Time;
import org.apache.flink.configuration.Configuration;
import org.apache.flink.runtime.e2data.handlers.utils.JarHandlerUtils;
...
public class JarPlanHandler
	...
	protected CompletableFuture<JobPlanInfo> handleRequest(
		...
		final JarHandlerUtils.JarHandlerContext context = JarHandlerUtils.JarHandlerContext.fromRequest(request, jarDir, log);
