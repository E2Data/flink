...
import org.apache.flink.runtime.e2data.PipelineErrorHandler;
...
/**
 * This classes encapsulates the boot-strapping of netty for the E2Data web-frontend.
 */
public class E2DataFrontendBootstrap {
	...
	public E2DataFrontendBootstrap(
			Router router,
			Logger log,
		...
		ChannelInitializer<SocketChannel> initializer = new ChannelInitializer<SocketChannel>() {
			...
			protected void initChannel(SocketChannel ch) {
				RouterHandler handler = new RouterHandler(E2DataFrontendBootstrap.this.router, new HashMap<>());
				...
				ch.pipeline()
					...
					.addLast(new PipelineErrorHandler(E2DataFrontendBootstrap.this.log));
			}
		};
